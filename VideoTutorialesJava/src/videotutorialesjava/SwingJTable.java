...
public class SwingJTable extends javax.swing.JDialog {
    ...
    DefaultTableModel dtmPaises = new DefaultTableModel();
    ArrayList<Pais> listaPaises = new ArrayList<>();
    public SwingJTable(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void setModelo(){
        String[] cabecera = {"N°","ID","Nombre"};
        dtmPaises.setColumnIdentifiers(cabecera);
        tblPaises.setModel(dtmPaises);
    }
    
    private void llenarLista(){
        String id = txtId.getText();
        String nombre = txtNombre.getText();
        Pais pais = new Pais(Integer.parseInt(id), nombre);
        listaPaises.add(pais);
    }
    
    private void setDatos(){
        Object[] datos = new Object[dtmPaises.getColumnCount()];
        int i=1;
        dtmPaises.setRowCount(0);
        for (Pais pais : listaPaises) {
            datos[0] = i;
            datos[1] = pais.getId();
            datos[2] = pais.getNombre();
            i++;
            dtmPaises.addRow(datos);            
        }
        tblPaises.setModel(dtmPaises);
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SwingJTable dialog = new SwingJTable(new javax.swing.JFrame(), true);
